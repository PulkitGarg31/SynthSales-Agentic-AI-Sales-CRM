...
AGENT_REGISTRY: list[tuple[str, str, str]] = [
    ...
    ("email_guess", "Email Guessing", "Generates likely email addresses from name + domain patterns."),
    ("verification", "Email Verification", "Verifies guessed emails: free syntax/MX checks first, then ZeroBounce/Verifalia for survivors; stops at the first deliverable address."),
